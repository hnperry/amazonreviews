...
The dataset and code are available in this repository. Please [click here](https://public.tableau.com/views/AmazonBookReviewsHarukiMurakami/Dashboard1?:language=en-US&:display_count=n&:origin=viz_share_link) to view the below visualization on Tableau.
...
At this point I think the [Tableau visualization](https://public.tableau.com/app/profile/nikki.perry/viz/AmazonBookReviewsHarukiMurakami/Dashboard1) speaks for itself, but I will include some screenshots here to provide narrative context. As I said before, please view the Tableau page on your desktop.
